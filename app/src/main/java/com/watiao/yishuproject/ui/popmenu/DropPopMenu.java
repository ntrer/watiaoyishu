package com.watiao.yishuproject.ui.popmenu;
...
public class DropPopMenu {
    ...
    private static final int INDICATOR_TO_CONTAINER_MIN_MARGIN = 10;
    private static final int MARGIN_SCREEN = 6;
    ...
    public void setTriangleIndicatorViewColor(int color) {
        mDropPopLayout.setTriangleIndicatorViewColor(Color.argb(80,0,0,0));
    }
...
//        setBackgroundAlpha(0f);
        ...
        if (mIsShowAtUp) {
            ...
            mPopupWindow.showAsDropDown(parent, 00, -50);
        }
        updateView();
    }
    ...
    private class DropPopMenuAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 0) {
                mWidth = mMaxTextWidth + mHorizontalMargin * 6;
                if (!iconIsGone) {
