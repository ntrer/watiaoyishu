...
public class JieShuAdapter extends BaseQuickAdapter<Test.DataListBean,BaseViewHolder> {
    ...
    public JieShuAdapter(int layoutResId, @Nullable List<Test.DataListBean> data) {
    ...
    protected void convert(BaseViewHolder helper, Test.DataListBean item) {
        try {
            ...
            helper.getView(R.id.yijieshu).setVisibility(View.VISIBLE);
            helper.getView(R.id.jinxingzhong).setVisibility(View.GONE);
