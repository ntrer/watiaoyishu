...
public class FenLeiSaiShi1Adapter extends BaseQuickAdapter<Test.DataListBean,BaseViewHolder> {
    ...
    public FenLeiSaiShi1Adapter(int layoutResId, @Nullable List<Test.DataListBean> data) {
