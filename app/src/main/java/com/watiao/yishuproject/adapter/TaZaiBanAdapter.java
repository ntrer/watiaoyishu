...
public class TaZaiBanAdapter extends BaseQuickAdapter<Test.DataListBean,BaseViewHolder> {
    ...
    public TaZaiBanAdapter(int layoutResId, @Nullable List<Test.DataListBean> data) {
    ...
    protected void convert(BaseViewHolder helper, Test.DataListBean item) {
        try {
            view= helper.getView(R.id.usr_img);
