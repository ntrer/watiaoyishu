...
public class GengDuoShiPinAdapter extends BaseQuickAdapter<Test.DataListBean,BaseViewHolder> {
    ...
    public GengDuoShiPinAdapter(int layoutResId, @Nullable List<Test.DataListBean> data) {
    ...
    protected void convert(BaseViewHolder helper, Test.DataListBean item) {
        try {
            ...
            helper.addOnClickListener(R.id.toupiao);
        }
        catch (Exception e){
