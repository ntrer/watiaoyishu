package com.watiao.yishuproject.adapter.CitySelectAdapter;
...
//                mHotData.add(mCities.get(index));
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        switch (viewType) {
            case 0:
                view = inflater.inflate(R.layout.locate_title, parent, false);
                break;
            case 1:
                ...
                RelativeLayout reload = (RelativeLayout) view.findViewById(R.id.reload);
