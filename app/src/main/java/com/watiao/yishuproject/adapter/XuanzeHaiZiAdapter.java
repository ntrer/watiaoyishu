...
public class XuanzeHaiZiAdapter extends BaseQuickAdapter<Test.DataListBean,BaseViewHolder> {

    private SmoothCheckBox mSmoothCheckBox;
    public static HashMap<Integer, Boolean> isSelected;
    private List<Test.DataListBean> datas;
    public XuanzeHaiZiAdapter(int layoutResId, @Nullable List<Test.DataListBean> data) {
