...
public class CaiYiShiPinAdapter extends BaseQuickAdapter<Test.DataListBean,BaseViewHolder> {
  ...
  private CircleImageView view2;
    ...
    public CaiYiShiPinAdapter(int layoutResId, @Nullable List<Test.DataListBean> data) {
