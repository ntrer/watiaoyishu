...
public class WoDeGuanZhuAdapter extends BaseQuickAdapter<Test.DataListBean,BaseViewHolder> {
    ...
    public WoDeGuanZhuAdapter(int layoutResId, @Nullable List<Test.DataListBean> data) {
    ...
    protected void convert(BaseViewHolder helper, Test.DataListBean item) {
        try {
            ...
            helper.getView(R.id.jiagaunzhu).setVisibility(View.GONE);
            helper.getView(R.id.yighuanzhu).setVisibility(View.VISIBLE);
        }
        catch (Exception e){
