...
public class ReMenSaiShiAdapter extends BaseQuickAdapter<Test.DataListBean,BaseViewHolder> {
    ...
    public ReMenSaiShiAdapter(int layoutResId, @Nullable List<Test.DataListBean> data) {
