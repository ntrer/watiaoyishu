...
import com.watiao.yishuproject.adapter.JInXingJieShuAdapter;
...
public class JinXingZhongFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private JInXingJieShuAdapter mJInXingJieShuAdapter;
    ...
    public static JinXingZhongFragment newInstance() {
        return new JinXingZhongFragment();
    }
    ...
    private void shouData(final List<Test.DataListBean> data) {
        try {
            mJInXingJieShuAdapter = new JInXingJieShuAdapter(R.layout.item_wodesaishi, data);
            final LinearLayoutManager manager = new LinearLayoutManager(getContext());
            mRvRecycleview.setLayoutManager(manager);
            mRvRecycleview.setAdapter(mJInXingJieShuAdapter);
            mJInXingJieShuAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                @Override
