...
public abstract class BaseActivity3 extends AppCompatActivity {
    ...
    private final String TAG = BaseActivity3.class.getName();
...
//        StatusBarCompat.setStatusBarColor(BaseActivity3.this,getResources().getColor(R.color.colorPrimary));
...
//    }
    ...
    public void showToastLong(String text) {
        if (toast == null) {
            toast = Toast.makeText(BaseActivity3.this, text, Toast.LENGTH_LONG);
        } else {
            toast.setText(text);
        }
        toast.show();
    ...
    public void showToastShort(String text) {
        if (toast == null) {
            toast = Toast.makeText(BaseActivity3.this, text, Toast.LENGTH_SHORT);
        } else {
            toast.setText(text);
        }
        toast.show();
    ...
    public void showProgress(String message) {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(BaseActivity3.this, ProgressDialog.STYLE_SPINNER);
