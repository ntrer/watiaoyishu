...
public abstract class BaseActivity4 extends AppCompatActivity {
    ...
    private final String TAG = BaseActivity4.class.getName();
...
//        StatusBarUtil.setStatusBarBackground_V21(this,getResources().getColor(R.color.white));
    ...
    private void initStatusBar() {
        ...
        if (statusBarView != null) {
            statusBarView.setBackgroundResource(R.drawable.bg_color2);
        }
    }
...
//    }
    ...
    public void showToastLong(String text) {
        if (toast == null) {
            toast = Toast.makeText(BaseActivity4.this, text, Toast.LENGTH_LONG);
        } else {
            toast.setText(text);
        }
        toast.show();
    ...
    public void showToastShort(String text) {
        if (toast == null) {
            toast = Toast.makeText(BaseActivity4.this, text, Toast.LENGTH_SHORT);
        } else {
            toast.setText(text);
        }
        toast.show();
    ...
    public void showProgress(String message) {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(BaseActivity4.this, ProgressDialog.STYLE_SPINNER);
