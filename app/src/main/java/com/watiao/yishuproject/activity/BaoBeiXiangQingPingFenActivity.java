...
public class BaoBeiXiangQingPingFenActivity extends BaseActivity {
    ...
    void header(){
        startActivity(new Intent(BaoBeiXiangQingPingFenActivity.this,MengWaZhuYeActivity.class));
    }
