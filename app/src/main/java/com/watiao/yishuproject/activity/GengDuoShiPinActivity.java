...
public class GengDuoShiPinActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener ,BaseSectionQuickAdapter.RequestLoadMoreListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequestDialog=creatRequestDialog2(GengDuoShiPinActivity.this,"投票中...");
    ...
    public int setLayout() {
        return R.layout.activity_geng_duo_shi_pin;
    }
    ...
    private void shouData(final List<Test.DataListBean> data) {
        try {
            ...
            final GridLayoutManager manager = new GridLayoutManager(GengDuoShiPinActivity.this, 2);
            ...
            mGengDuoShiPinAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                ...
                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                    Intent intent=new Intent(GengDuoShiPinActivity.this,BaoBeiXiangQingActivity.class);
    ...
    @OnClick(R.id.search)
    void search(){
        startActivity(new Intent(GengDuoShiPinActivity.this,ShiPinSouSuoActivity.class));
    }
