...
public class TianJiaYanYiJIngLiActivity extends BaseActivity {
    ...
    public int setLayout() {
        return R.layout.activity_tian_jia_yan_yi_jing_li;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                hideSoftKeyboard(TianJiaYanYiJIngLiActivity.this);
                finish();
                break;
        }
