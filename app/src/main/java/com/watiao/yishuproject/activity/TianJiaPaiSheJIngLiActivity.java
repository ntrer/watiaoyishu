...
public class TianJiaPaiSheJIngLiActivity extends BaseActivity {
    ...
    public int setLayout() {
        return R.layout.activity_tian_jia_pai_she_jing_li;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                hideSoftKeyboard(TianJiaPaiSheJIngLiActivity.this);
                finish();
                break;
        }
