...
public class BasePickerView2 {
    ...
    public BasePickerView2(Context context) {
        ...
        mPickerOptions.decorView.post(new Runnable() {
            ...
            public void run() {
                ...
                if (onDismissListener != null) {
                    onDismissListener.onDismiss(BasePickerView2.this);
                }
            }
        });
    ...
    public BasePickerView2 setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    protected BasePickerView2 setOutSideCancelable(boolean isCancelable) {
