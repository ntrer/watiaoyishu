...
public class MusicAdapter extends RecyclerView.Adapter{
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        ((MusicViewHolder)holder).mButton.setTag(position);
        switch (viewType) {
        case VIEW_TYPE_NO:
            ...
            ((MusicViewHolder)holder).mButton.setVisibility(View.GONE);
        ...
        case VIEW_TYPE_LOCAL:
            ...
            if (position == mSelectIndex) {
                ((MusicViewHolder)holder).mLocalIcon.setVisibility(View.GONE);
                ((MusicViewHolder)holder).mButton.setVisibility(View.VISIBLE);
                ((MusicViewHolder)holder).musicName.setSelected(true);
                ((MusicViewHolder)holder).musicSinger.setSelected(true);
    ...
    class MusicViewHolder extends RecyclerView.ViewHolder {
        ...
        public MusicViewHolder(View itemView) {
            ...
            mButton=itemView.findViewById(R.id.shiyong);
            ...
            mButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    mOnItemChildClickListener.onItemClick(view, ViewName.PRACTISE, position);
                }
            });
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Log.d("asds",mSelectIndex+"-----"+mPosition);
    ...
    private OnItemChildClickListener mOnItemChildClickListener;//声明自定义的接口
