...
public class MusicChooseView extends LinearLayout implements View.OnClickListener {
    ...
    private void initView() {
        ...
        if (mMusicAdapter == null) {
            ...
            mMusicAdapter.setOnItemChildClickListener(new MusicAdapter.OnItemChildClickListener() {
                @Override
                public void onItemClick(View v, MusicAdapter.ViewName viewName, int position) {
