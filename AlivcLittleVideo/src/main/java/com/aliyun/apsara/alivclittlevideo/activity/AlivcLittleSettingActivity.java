...
public class AlivcLittleSettingActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        textView.setText(String.format("包含短视频版本号【%s】 \n 播放器版本号【%s】",Version.VERSION ,AliPlayerFactory.getSdkVersion() ));
        TextView tvVersionTip = findViewById(R.id.tv_mine_id);
        String versionName = getVersionName(this);
        String tip = getResources().getString(R.string.alivc_little_video_version_code)+versionName;
