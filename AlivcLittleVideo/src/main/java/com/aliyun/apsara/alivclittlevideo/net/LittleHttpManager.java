...
public class LittleHttpManager {
    ...
    public void newGuest(HttpEngine.HttpResponseResultCallback<LittleHttpResponse.LittleUserInfoResponse> callback) {
        Request request = new Request.Builder().url(AlivcLittleServerApiConstants.URL_NEW_GUEST)
        .get()
        .build();
     ...
     */
    public void requestChangeNickName(String userId, String token, String newNickName, HttpEngine.HttpResponseResultCallback<LittleHttpResponse.LittleUserInfoResponse> callback) {
     ...
     */
    public void requestMineVideoList(String token, int pageIndex, int pageSize, int id, HttpEngine.HttpResponseResultCallback<LittleHttpResponse.LittleMyVideoListResponse> callback) {
        ...
        Request request = new Request.Builder().url(urlAppend(AlivcLittleServerApiConstants.URL_GET_PERSIONAL_VIDEO_LIST, hashMap))
        .get()
        .build();
     ...
     * @param callback
     */
    public void requestRecommonVideoList(String token, int pageIndex, int pageSize, int id, HttpEngine.HttpResponseResultCallback<LittleHttpResponse.LittleMyVideoListResponse> callback) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put(AlivcLittleHttpConfig.RequestKey.FORM_KEY_PAGE_INDEX, pageIndex + "");
        hashMap.put(AlivcLittleHttpConfig.RequestKey.FORM_KEY_PAGE_SIZE, pageSize + "");
        hashMap.put(AlivcLittleHttpConfig.RequestKey.FORM_KEY_TOKEN, token);
        ...
        Request request = new Request.Builder().url(urlAppend(AlivcLittleServerApiConstants.URL_GET_RECOMMEND_VIDEO_LIST, hashMap))
        .get()
        .build();
        mHttpEngine.request(request, LittleHttpResponse.LittleMyVideoListResponse.class, callback);
    }
    ...
    public void requestVideoUploadAuth(String title,String fileName,HttpEngine.HttpResponseResultCallback<LittleHttpResponse.LittleVideoUploadAuthResponse> callback){
        LittleUserInfo userInfo = AlivcLittleUserManager.getInstance().getUserInfo();
        String token = "";
        if (userInfo!=null){
            token = userInfo.getToken();
        ...
        Request request = new Request.Builder().url(urlAppend(AlivcLittleServerApiConstants.URL_GET_VIDEO_UPLOAD_AUTH, hashMap))
        .get()
        .build();
     ...
     * @param callback
     */
    public void refreshVideoUploadAuth(String videoId, HttpEngine.HttpResponseResultCallback<LittleHttpResponse.LittleVideoUploadAuthResponse> callback) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put(AlivcLittleHttpConfig.RequestKey.FORM_KEY_VIDEO_ID, videoId );
        Request request = new Request.Builder().url(urlAppend(AlivcLittleServerApiConstants.URL_REFRESH_VIDEO_UPLOAD_AUTH, hashMap))
        .get()
        .build();
        mHttpEngine.request(request, LittleHttpResponse.LittleVideoUploadAuthResponse.class, callback );
    }
     ...
     * @param callback
     */
    public void requestImageUploadAuth(HttpEngine.HttpResponseResultCallback<LittleHttpResponse.LittleImageUploadAuthResponse> callback){
        LittleUserInfo userInfo = AlivcLittleUserManager.getInstance().getUserInfo();
        ...
        Request request = new Request.Builder().url(urlAppend(AlivcLittleServerApiConstants.URL_GET_IMAGE_UPLOAD_AUTH, hashMap))
        .get()
        .build();
     ...
     * @param callback callback
     */
    public void requestDeleteVideo(String token, String userId, String videoId, HttpEngine.HttpResponseResultCallback<LittleHttpResponse.LittleMyVideoListResponse> callback) {
