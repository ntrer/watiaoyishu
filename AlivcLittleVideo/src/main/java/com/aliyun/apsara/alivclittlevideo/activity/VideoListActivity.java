...
public class VideoListActivity extends AppCompatActivity {
    ...
    private void loadPlayList(final int id) {
        ...
        if (userInfo == null) {
            Toast.makeText(this, "R.string.alivc_little_no_user:" + R.string.alivc_little_no_user, Toast.LENGTH_SHORT)
            .show();
            return;
        }
    ...
    private void jumpToRecorder() {
        ...
        .build();
        AlivcSvideoRecordActivity.startRecord(this, recordParam, INTENT_PARAM_ENTRANCE_VALUE);
    }
    /**
     * 视频播放列表刷新、加载更多事件监听
     */
