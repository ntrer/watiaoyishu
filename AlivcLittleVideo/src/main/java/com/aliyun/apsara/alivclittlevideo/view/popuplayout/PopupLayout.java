package com.aliyun.apsara.alivclittlevideo.view.popuplayout;
...
public class PopupLayout {
    ...
    public static PopupLayout init(Context context,@LayoutRes int contentLayoutId){
        ...
        popupLayout.mPopupDialog.getWindow().setDimAmount(0f);
        popupLayout.mPopupDialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_NOTHING);
        popupLayout.mPopupDialog.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
