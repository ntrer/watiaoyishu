...
public class LittleMineVideoInfo implements Parcelable {
    ...
    public static class VideoListBean extends BaseVideoSourceModel implements Parcelable {
        ...
        public static class UserBean implements Parcelable {
            ...
            public UserBean(String userId, String userName, String avatarUrl) {
                this.userId = userId;
        ...
        public static final Creator<VideoListBean> CREATOR = new Creator<VideoListBean>() {
            @Override
            public VideoListBean createFromParcel(Parcel source) {return new VideoListBean(source);}

            @Override
            public VideoListBean[] newArray(int size) {return new VideoListBean[size];}
        };
    }
}
