...
import com.aliyun.svideo.editor.util.MessageEvent;
...
public class EditorActivity extends FragmentActivity {
    ...
    private AlivcEditView editViews;
    /**
     * 是否替换原视频中音乐
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editViews = findViewById(R.id.alivc_edit_views);
        ...
        if ("svideo".equals(entrance)) {
            editViews.setParam(mVideoParam, mUri, hasTailAnimation, true);
        } else {
            editViews.setParam(mVideoParam, mUri, hasTailAnimation, false);
        }
        editViews.setReplaceMusic(isReplaceMusic);
        ...
        editViews.setHasRecordMusic(mHasRecordMusic);
    ...
    public void Event(MessageEvent messageEvent) {
        if(messageEvent.getMessage().equals("发布")){
//            EventBus.getDefault().post(new MessageEvent("编辑"));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (editViews != null) {
            editViews.onActivityResult(requestCode, resultCode, data);
        }
    }
    ...
    public void onBackPressed() {
        ...
        if (editViews != null) {
            isConsume = editViews.onBackPressed();
        }
        if (!isConsume) {
            super.onBackPressed();
            finish();
